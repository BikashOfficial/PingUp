    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
          ...
          <h1 className='text-3xl md:text-6xl font-bold md:pb-2 bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More than just friends truely connect</h1>
